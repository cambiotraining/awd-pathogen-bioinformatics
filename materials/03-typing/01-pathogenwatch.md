...
::: {.callout-tip}
#### Learning Objectives
At the end of this session you will be able to perform the following in the pathogenwatch:

- Uploading genome assemblies files in FASTA format and other files particularly metadata.
- Creating collection of asssembled genomes
- Viweing phylogenetic tree and determining a population in which your genome isolates cluster with.
- Identifying antibiotic resistance genes from your uploaded genome assemblies
- Identify strains and sequence typings for your uploaded genome isolates
- Downloading different files from the pathogenwatch.
- Identifying possible antimicrobial resistance drugs associated with your strain.
...
Create a new collection including your samples and other _Vibrio_ genomes we downloaded from NCBI (in the `resources/vibrio_genomes` folder).
...
## Summary
In this section you have learned how to use pathogenwatch to perform basic genomic surveillance tasks such as strain identification, determining sublineage which your isolates belong to using autogenerated phylogenetic tree, identifying AMR genes and the resistance genes associated with. However for low-resource setting countries pathogenwatch might be not a good option in particular when there is low Internet speed.

::: {.callout-tip}
#### Key Points
- You can do many things with pathogenwatch such as uploading your genomes, creating collections, performing AMR analysis and multilocus sequence typing.
